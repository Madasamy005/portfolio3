...
const About = () => {
  return (
    <div id="about" className="bg-[#fff] min-h-screen flex items-center">
      <div className="max-w-[90%] md:max-w-[75%] mx-auto font-inter space-y-10 py-10">
        ...
        <p className="text-lg md:text-xl text-gray-700 text-center leading-relaxed">
          I’m <span className="font-bold text-[#fe5617]">Madasamy</span>,I hold a Bachelor’s degree in Computer Science from Anna University.
          I am a passionate Full-Stack Developer with a strong foundation in front-end 
          and back-end technologies. As a tech enthusiast, I love building dynamic, 
          user-friendly web applications that solve real-world problems. 
          I have hands-on experience with HTML, CSS, JavaScript, React, Node.js, Express, and MongoDB, 
