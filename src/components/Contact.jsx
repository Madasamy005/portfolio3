...
const Contact = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", import.meta.env.VITE_WEB3_FORM_API);
          ...
          <div className="flex flex-col space-y-5 text-lg md:text-xl font-semibold">
            ...
            <div className="flex flex-col items-center gap-3">
              ...
              <div className="flex gap-4">
                <a
                  href="https://github.com/Madasamy005"
                  className="hover:text-[#fe5617]"
                >
                  <FaGithub size={29} />
                </a>
                <a
                  href="https://www.linkedin.com/in/madasamy-p-a6b306248?"
                  className="hover:text-[#fe5617]"
                >
                  <FaLinkedin size={29} />
                </a>
                <a
                  href="https://www.instagram.com/m_a_d_d_y__mahesh?"
                  className="hover:text-[#fe5617]"
                >
                  <FaInstagram size={29} />
                </a>
